...
<template>
      ...
      <div class="summary">
        <table>
          <tr>
            <th>GitHub</th>
            <td>
              <a href="https://github.com/newt239/SHIP-notify-public" target="_blank">newt239/SHIP-notify-public</a>
            </td>
          </tr>
          <tr>
            <th>Creation</th>
  ...
  <div class="content">
    ...
    <ul>
      <li>
        <a href="https://ship-assistant.web.app/" target="_blank">https://ship-assistant.web.app/</a>
      </li>
    </ul>
    <h5>Notion上で利用方法を説明したページ</h5>
    <ul>
      <li>
        <a href="https://www.notion.so/newt-house/SHIP-Assistant-s-Note-c599cf2125364a80920b0447f76d717a"
          target="_blank">SHIP Assistant's Note</a>
      </li>
    </ul>
  </div>
</template>